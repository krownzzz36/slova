...
var CORE = [
  './', './index.html',
  './src/rules.js?v=12', './src/morph.js?v=12', './src/dict.js?v=12',
  './src/stats.js?v=12', './src/storage.js?v=12', './src/sharecard.js?v=12',
  './src/score.js?v=12', './src/ui.js?v=12',
  './data/dict-data.js?v=12', './data/themes.js?v=12'
];
